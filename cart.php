					...
					<div class="tab-pane active" id="horizontal-form">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
										<input type="text" class="form-control1 input-sm" name="mo" id="smallinput" pattern="08[0-9]{9,11}" title="Masukkan nomor handphone Indonesia yang valid (contoh: 08123456789)" maxlength="13" placeholder="08123456789" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required/>
								</div>
							</div>
							<div class="form-group">
