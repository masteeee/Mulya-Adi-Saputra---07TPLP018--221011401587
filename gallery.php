...
<link href="css/font-awesome.css" rel="stylesheet"> 
	...
	<div class="gallery-top">
		<!-- container -->
		<div class="container">
			<h2 class="w3ls-title1"><?php echo t('our'); ?> <span><?php echo t('gallery'); ?></span></h2>
			...
			<div class="gallery-grids-top">
				...
				<div class="col-md-3 gallery-grid">
						...
						<a href="book_wed.php?id=<?php echo $row['id']; ?>"><?php echo "<input type='button' value='".t('book_now')."' class='btn my'/>" ;?></a><br />
					</div>
					<?php } ?>
